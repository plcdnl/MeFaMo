...
# orig
        ...
        config = {
            FaceBlendShape.EyeBlinkLeft: (0.55, 0.80),      # good magic number for my face
            FaceBlendShape.EyeLookDownLeft: (0.0, 1.0),
            FaceBlendShape.EyeLookInLeft: (0.0, 1.0),
            FaceBlendShape.EyeLookOutLeft: (0.0, 1.0),
            FaceBlendShape.EyeLookUpLeft: (0.0, 1.0),
            FaceBlendShape.EyeSquintLeft: (0.37, 0.44),
            FaceBlendShape.EyeWideLeft: (1.05, 1.15),         # good magic number for my face
            FaceBlendShape.EyeBlinkRight: (0.55, 0.85),     # good magic number for my face
            FaceBlendShape.EyeLookDownRight: (0.0, 1.0),
            FaceBlendShape.EyeLookInRight: (0.0, 1.0),
            FaceBlendShape.EyeLookOutRight: (0.0, 1.0),
            FaceBlendShape.EyeLookUpRight: (0.0, 1.0),
            FaceBlendShape.EyeSquintRight: (0.37, 0.44),
            FaceBlendShape.EyeWideRight: (1.05, 1.2),        # good magic number for my face
            # FaceBlendShape.JawForward: (0.0, 1.0),
            FaceBlendShape.JawLeft: (-0.4, 0.0),
            FaceBlendShape.JawRight: (0.0, 0.4),
            FaceBlendShape.JawOpen: (0.5, 0.55),
            FaceBlendShape.MouthClose: (4.0, 5.0),          # good magic number for my face
            FaceBlendShape.MouthFunnel: (4.0, 4.8),
            FaceBlendShape.MouthPucker: (3.46, 4.92),
            FaceBlendShape.MouthLeft: (0.0, 1.0),
            FaceBlendShape.MouthRight: (0.0, 1.0),
            FaceBlendShape.MouthSmileLeft: (-0.25, 0.0),
            FaceBlendShape.MouthSmileRight: (-0.25, 0.0),
            FaceBlendShape.MouthFrownLeft: (0.4, 0.9),
            FaceBlendShape.MouthFrownRight: (0.4, 0.9),
            # FaceBlendShape.MouthDimpleLeft: (0.0, 1.0),
            # FaceBlendShape.MouthDimpleRight: (0.0, 1.0),
            FaceBlendShape.MouthStretchLeft: (-0.4, 0.0),
            FaceBlendShape.MouthStretchRight: (-0.4, 0.0),
            FaceBlendShape.MouthRollLower: (0.4, 0.7),
            FaceBlendShape.MouthRollUpper: (0.31, 0.34),
            ...
            FaceBlendShape.MouthLowerDownLeft: (1.7, 2.1),
            FaceBlendShape.MouthLowerDownRight: (1.7, 2.1),
            # FaceBlendShape.MouthUpperUpLeft: (0.0, 1.0),
            # FaceBlendShape.MouthUpperUpRight: (0.0, 1.0),
            FaceBlendShape.BrowDownLeft: (0.8, 1.1),
            FaceBlendShape.BrowDownRight: (0.8, 1.1),
            FaceBlendShape.BrowInnerUp: (2.0, 2.6),
            FaceBlendShape.BrowOuterUpLeft: (1.25, 1.5),
            FaceBlendShape.BrowOuterUpRight: (1.25, 1.5),
            # FaceBlendShape.CheekPuff: (0.0, 1.0),
            FaceBlendShape.CheekSquintLeft: (0.35, 0.63),
            FaceBlendShape.CheekSquintRight: (0.35, 0.63),
            # FaceBlendShape.NoseSneerLeft: (0.0, 1.0),
            # FaceBlendShape.NoseSneerRight: (0.0, 1.0),
            # FaceBlendShape.TongueOut: (0.0, 1.0),
            FaceBlendShape.HeadYaw: (-1.0, 1.0),
            FaceBlendShape.HeadPitch: (-1.0, 1.0),
            FaceBlendShape.HeadRoll: (-1.0, 1.0),
            FaceBlendShape.LeftEyeYaw: (-1.0, 1.0),
            FaceBlendShape.LeftEyePitch: (-1.0, 1.0),
            FaceBlendShape.LeftEyeRoll: (-1.0, 1.0),
            FaceBlendShape.RightEyeYaw: (-1.0, 1.0),
            FaceBlendShape.RightEyePitch: (-1.0, 1.0),
            FaceBlendShape.RightEyeRoll: (-1.0, 1.0)
        }
